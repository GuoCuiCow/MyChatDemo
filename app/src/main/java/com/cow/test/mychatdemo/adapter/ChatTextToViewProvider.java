...
public class ChatTextToViewProvider extends ItemViewProvider<MessageBean, ChatTextToViewProvider.ViewHolder> {

    @NonNull
    @Override
    protected ChatTextToViewProvider.ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View root = inflater.inflate(R.layout.item_detail_text_to, parent, false);
        return new ChatTextToViewProvider.ViewHolder(root);
    }

    @Override
    protected void onBindViewHolder(@NonNull ChatTextToViewProvider.ViewHolder holder, @NonNull MessageBean message) {
